...
public class ImprimirCorteWeb extends AsyncTask<Void, Void, String> {
    ...
    public ImprimirCorteWeb(String Usuario) {
        this.usuario = Usuario;
        if (this.usuario.equals("Vivi")) {
            url = "http://192.168.1.78:88/cereales/site_php/wsObtenerCorte.php?idusuario=2&usuario=Vivi";
